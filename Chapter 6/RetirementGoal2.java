...
public class RetirementGoal2 {
    ...
    public static void main(String[] args) {
        ...
        double principle = getInterest(years, save);
        System.out.print("You will have $" + principle + " at retirement."); 
    }

    private static double getInterest(int years, int save) {
        double principle = years * save;
